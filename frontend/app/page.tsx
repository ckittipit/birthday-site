...
export default function HomePage() {
	...
	const [wishName, setWishName] = useState('Beaut')
						...
						{showBouquet && (
							<div className='mx-auto max-w-sm rounded-[2rem] border border-white/50 bg-white/45 p-5 text-center backdrop-blur-sm'>
								...
								<p className='mt-3 text-base leading-7 text-[--color-midnight]/80'>
									สุขสันต์วันเกิดนะบิ้วคนเก่ง
									ขอให้ทุกวันหลังจากนี้มีแต่เรื่องดี ๆ คนดี ๆ
									และความฝันที่ค่อย ๆ
									ผลิบานเหมือนดอกแคสเปียในช่อนี้
								</p>
								...
								<section className='mx-auto mt-10 max-w-3xl rounded-[2rem] border border-white/40 bg-white/25 p-6 shadow-[--shadow-bloom] backdrop-blur-md'>
									<div className='text-sm font-bold uppercase tracking-[0.25em] text-[--color-plum]'>
										Birthday Wish
									</div>

									<h2 className='mt-3 text-2xl font-black text-[--color-midnight]'>
										Now it's time for you to make yourself a
										wish.
									</h2>

									{/* <p className='mt-2 text-sm text-[--color-midnight]/70'>
										พิมพ์ชื่อและคำอวยพรของคุณ
										แล้วกดส่งเพื่อบันทึกลงฐานข้อมูล
									</p> */}
									...
									<div className='mt-6 grid gap-4'>
										{/* <input
											...
											maxLength={100}
											className='w-full rounded-2xl border border-white/60 bg-white/70 px-4 py-3 text-[--color-midnight] outline-none placeholder:text-[--color-midnight]/40'
										/> */}
										...
										<div className='flex flex-wrap items-center justify-center gap-3'>
											<motion.button
												...
												className='rounded-full bg-blue-500 px-6 py-3 font-semibold text-white shadow-[--shadow-bloom] disabled:opacity-60'
											>
												{isSubmitting
													? 'กำลังบันทึก...'
													: 'ส่งคำอวยพร'}
											...
											{submitStatus && (
												<div className='text-sm font-medium text-[--color-midnight]/80'>
													{submitStatus}
												</div>
											)}
										</div>
